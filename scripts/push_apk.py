...
class PushAPK(BaseScript, GooglePlayMixin, VirtualenvMixin):
    ...
    config_options = [
        ...
        [["--apk-armv7"], {
            "dest": "apk_file_armv7",
            "help": "The path to the ARM v7 APK file",
        }],
        [["--apk-armv6"], {
            "dest": "apk_file_armv6",
    ...
    def check_argument(self):
        ...
        if not os.path.isfile(self.config['apk_file_armv7']):
            self.fatal("Could not find " + self.config['apk_file_armv7'])
    ...
    def push_apk(self):
        ...
        apks = [self.config['apk_file_armv7'], self.config['apk_file_x86']]
