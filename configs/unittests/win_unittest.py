...
config = {
    ...
    "all_mochitest_suites":
    {
        ...
        "mochitest-devtools-chrome-1": ["--browser-chrome", "--subsuite=devtools", "--total-chunks=2", "--this-chunk=1"],
        "mochitest-devtools-chrome-2": ["--browser-chrome", "--subsuite=devtools", "--total-chunks=2", "--this-chunk=2"],
