...
config = {
    ...
    "all_mochitest_suites": {
        ...
        "mochitest-devtools-chrome-1": ["--browser-chrome", "--subsuite=devtools", "--total-chunks=3", "--this-chunk=1"],
        "mochitest-devtools-chrome-2": ["--browser-chrome", "--subsuite=devtools", "--total-chunks=3", "--this-chunk=2"],
        "mochitest-devtools-chrome-3": ["--browser-chrome", "--subsuite=devtools", "--total-chunks=3", "--this-chunk=3"],
        "a11y": ["--a11y"],
